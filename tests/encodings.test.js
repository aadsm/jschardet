...
test("ASCII", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("ascii")
});

test("UTF-8 w/o BOM (short)", function() {
    // àí
    var str = "\xc3\xa0\xc3\xad";
    expect(jschardet.detect(str).encoding).toBe("UTF-8")
});
...
test("UTF-8 w/o BOM (short, stream)", function() {
    ...
    u.close();
    expect(u.result.encoding).toBe("UTF-8")
});
...
test("UTF-16BE", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("UTF-16BE")
});

test("UTF-16LE", function() {
    var str = "\xFF\xFEutf16le string";
    expect(jschardet.detect(str).encoding).toBe("UTF-16LE")
});

test("UTF-32BE", function() {
    var str = "\x00\x00\xFE\xFFutf32be string";
    expect(jschardet.detect(str).encoding).toBe("UTF-32BE")
});

test("UTF-32LE", function() {
    var str = "\xFF\xFE\x00\x00utf32le string";
    expect(jschardet.detect(str).encoding).toBe("UTF-32LE")
});

test("X-ISO-10646-UCS-4-3412", function() {
    var str = "\xFE\xFF\x00\x00ucs4 3412 string";
    expect(jschardet.detect(str).encoding).toBe("X-ISO-10646-UCS-4-3412")
});

test("X-ISO-10646-UCS-4-2143", function() {
    var str = "\x00\x00\xFF\xFEucs4 2143 string";
    expect(jschardet.detect(str).encoding).toBe("X-ISO-10646-UCS-4-2143")
});
...
test("ISO-8859-2 (Hungarian)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("ISO-8859-2")
});
...
test("ISO-8859-5 (Russian)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("ISO-8859-5")
});
...
test("ISO-8859-7 (Greek)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("ISO-8859-7")
});
...
test("ISO-8859-8 (Visual Hebrew)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("ISO-8859-8")
});
...
test("ISO-2022-KR", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("ISO-2022-KR")
});
...
test("ISO-2022-JP", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("ISO-2022-JP")
});
...
test("windows-1251 (Russian)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("windows-1251")
});
...
test("windows-1255 (Logical Hebrew)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("windows-1255")
});
...
test("KOI8-R (Russian)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("KOI8-R")
});
...
test("x-mac-cyrillic (Russian)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("x-mac-cyrillic")
});
...
test("IBM855 (Russian)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("IBM855")
});
...
test("IBM866 (Russian)", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("IBM866")
});
...
test("EUC-KR", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("EUC-KR")
});
...
test("EUC-JP", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("EUC-JP")
});
...
test("TIS-620", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("TIS-620")
});
...
test("SHIFT_JIS", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("SHIFT_JIS")
});

test("Big5", function() {
    // 次常用國字標準字體表
    var str = "\xA6\xB8\xB1\x60\xA5\xCE\xB0\xEA\xA6\x72\xBC\xD0\xB7\xC7\xA6\x72\xC5\xE9\xAA\xED";
    expect(jschardet.detect(str).encoding).toBe("Big5")
});
...
test("GB2312/GB18030", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("GB2312")
});
...
test("HZ-GB-2312", function() {
    ...
    expect(jschardet.detect(str).encoding).toBe("HZ-GB-2312")
});
...
describe.skip("Not sure how to test these", function() {
    test("ISO-2022-CN", function() {
        // 🤷
        var str = "";
        expect(jschardet.detect(str).encoding).toBe("ISO-2022-CN", "")
    });
    ...
    test("windows-1253 (Greek)", function() {
        ...
        var str = "";
        expect(jschardet.detect(str).encoding).toBe("windows-1253")
    });

    test("EUC-CN", function() {
        // 🤷
        var str = "";
        expect(jschardet.detect(str).encoding).toBe("EUC-CN")
    });
