...
import { BigramProfile, RARE_LANGUAGES, THIN_RARE_MAX_BYTES, hasModelVariants, inferLanguage, scoreBestLanguage, } from '../models/index.js';
...
export function fillLanguages(data, results) {
    ...
    for (const result of results) {
        ...
        if (lang === null && data.length > 0 && hasModelVariants(encoding)) {
            if (profile === null)
                profile = new BigramProfile(data);
