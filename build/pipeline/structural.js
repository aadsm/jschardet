...
// share a single pass.
export function _analyzeShiftJis(data) {
...
export function _analyzeCp932(data) {
...
export function _analyzeEucJp(data) {
...
export function _analyzeEucKr(data) {
...
export function _analyzeCp949(data) {
...
export function _analyzeGb18030(data) {
...
export function _analyzeBig5(data) {
...
export function _analyzeBig5hkscs(data) {
...
export function _analyzeJohab(data) {
...
function _getAnalysis(data, name, ctx) {
...
export function computeStructuralScore(data, encodingInfo, ctx) {
    if (data.length === 0 || !encodingInfo.isMultibyte)
        return 0.0;
...
export function computeMultibyteByteCoverage(data, encodingInfo, ctx, nonAsciiCount) {
    if (data.length === 0 || !encodingInfo.isMultibyte)
        return 0.0;
    const result = _getAnalysis(data, encodingInfo.name, ctx);
    if (result === null)
...
export function computeLeadByteDiversity(data, encodingInfo, ctx) {
    if (data.length === 0 || !encodingInfo.isMultibyte)
        return 0;
    const result = _getAnalysis(data, encodingInfo.name, ctx);
    if (result === null)
